        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckinLatitude = table.Column<decimal>(type: "decimal(12,9)", precision: 12, scale: 9, nullable: false),
                    CheckinLongitude = table.Column<decimal>(type: "decimal(12,9)", precision: 12, scale: 9, nullable: false),
                    CheckinTimestamp = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CheckinDistanceMeters = table.Column<double>(type: "double", nullable: false),
                    CheckoutLatitude = table.Column<decimal>(type: "decimal(12,9)", precision: 12, scale: 9, nullable: true),
                    CheckoutLongitude = table.Column<decimal>(type: "decimal(12,9)", precision: 12, scale: 9, nullable: true),
                    CheckoutTimestamp = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CheckoutDistanceMeters = table.Column<double>(type: "double", nullable: true),
                    DurationMinutes = table.Column<int>(type: "int", nullable: true),
                    CheckoutSummary = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checkins_Sellers_SellerId",
                        column: x => x.SellerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visits_Seller_ActiveOnly",
                table: "Checkins",
                columns: new[] { "SellerId", "CheckoutTimestamp" },
                filter: "`CheckoutTimestamp` IS NULL");
